...
-- Seed: Electronics (category_id = 1)
...
-- Seed: Home & Garden (category_id = 3)
...
-- Seed: Sports & Outdoors (category_id = 5)
...
-- Seed: Food & Beverages (category_id = 6)
