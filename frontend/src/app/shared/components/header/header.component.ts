                  ...
                  @if (cart(); as cartData) {
                    @if (cartData.items.length > 0) {
                        ...
                        @for (item of cartData.items; track item.id) {
                          <div class="flex items-center gap-3 py-2.5">
                            ...
                            <div class="flex items-center gap-1 shrink-0">
                              ...
                              <span
                                class="text-xs font-medium w-5 text-center"
                                data-testid="drawer-qty-value"
                                >{{ item.quantity }}</span
                              >
                              <button
                                hlmBtn
                      ...
                      <div class="flex flex-col items-center justify-center py-12 text-center">
                        <svg
                          class="w-12 h-12 text-muted-foreground/40 mb-4"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  @if (cart(); as cartData) {
                    @if (cartData.items.length > 0) {
                      ...
                      <button
                        ...
                        variant="ghost"
                        size="sm"
                        class="w-full text-destructive hover:text-destructive mt-1"
